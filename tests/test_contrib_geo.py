...
class GeometryFieldDefinitionTestMixin(FieldDefinitionTestMixin):
    ...
    def setUpTestData(cls):
        cls.field_definition_cls = import_string(
            "mutant.contrib.geo.models.%s" % cls.field_definition_cls_name
        )
        ...
        BaseDefinition.objects.create(
            model_def_id=cls.model_def_pk, base=GeoModel
        )
...
class GeometryFieldDefinitionTest(
    GeometryFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
...
class PointFieldDefinitionTest(
    GeometryFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
...
class LineStringFieldDefinitionTest(
    GeometryFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
...
class PolygonFieldDefinitionTest(
    GeometryFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
...
class MultiLineStringFieldDefinitionTest(
    GeometryFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
...
class MultiPointFieldDefinitionTest(
    GeometryFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
...
class MultiPolygonFieldDefinitionTest(
    GeometryFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
