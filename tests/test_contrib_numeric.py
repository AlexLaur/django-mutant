...
class SmallIntegerFieldDefinitionTest(
    NumericFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
...
class PositiveSmallIntegerFieldDefinitionTest(
    NumericFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
...
class IntegerFieldDefinitionTest(
    NumericFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
...
class PositiveIntegerFieldDefinitionTest(
    NumericFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
...
class BigIntegerFieldDefinitionTest(
    NumericFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
...
class FloatFieldDefinitionTest(
    NumericFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
...
class DecimalFieldDefinitionTest(
    NumericFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
