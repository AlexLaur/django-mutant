...
class EmailFieldDefinitionTest(
    WebFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
    field_definition_cls = EmailFieldDefinition
    field_values = ("guido@python.org", "god@heaven.com")


class IPAddressFieldDefinitionTest(
    WebFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
...
class SlugFieldDefinitionTest(
    WebFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
    field_definition_cls = SlugFieldDefinition
    field_values = ("an-awesome-slug_-_-", "2012-4-7-so-late")


class URLFieldDefinitionTest(
    WebFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
...
class GenericIPAddressFieldDefinitionTest(
    WebFieldDefinitionTestMixin, BaseModelDefinitionTestCase
):
    field_definition_cls = GenericIPAddressFieldDefinition
    field_values = ("127.0.0.1", "2001:db8:85a3::8a2e:370:7334")
