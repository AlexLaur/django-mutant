        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Automatically set the field to now every time the object is saved.",
                        verbose_name="auto now",
                    ),
                ),
                (
                    "auto_now_add",
                    models.BooleanField(
                        default=False,
                        help_text="Automatically set the field to now when the object is first created.",
                        verbose_name="auto now add",
                    ),
                ),
            ],
            options={
