...
auto_now_help_text = _(
    "Automatically set the field to now every time the " "object is saved."
)
auto_now_add_help_text = _(
    "Automatically set the field to now when the " "object is first created."
)


class DateFieldDefinition(FieldDefinition):
    auto_now = fields.BooleanField(
        _("auto now"), default=False, help_text=auto_now_help_text
    )
    auto_now_add = fields.BooleanField(
        _("auto now add"), default=False, help_text=auto_now_add_help_text
    )
