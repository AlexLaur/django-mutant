        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=4326,
                        help_text="Spatial Reference System Identity",
                        verbose_name="SRID",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Creates a spatial index for the given geometry field.",
                        verbose_name="spatial index",
                    ),
                ),
                (
                    "dim",
                    models.PositiveSmallIntegerField(
                        default=2,
                        help_text="Coordinate dimension.",
                        verbose_name="coordinate dimension",
                        choices=[
                            (2, "Two-dimensional"),
                            (3, "Three-dimensional"),
                        ],
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Creates a database column of type geography, rather than geometry.",
