            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        help_text="The maximum number of digits allowed in the number. Note that this number must be greater than or equal to ``decimal_places``, if it exists.",
                        verbose_name="max digits",
                    ),
                ),
                (
                    "decimal_places",
                    models.PositiveSmallIntegerField(
                        help_text="The number of decimal places to store with the number.",
